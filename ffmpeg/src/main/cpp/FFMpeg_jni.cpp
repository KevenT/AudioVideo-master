...
jint Java_edu_wuwang_ffmpeg_FFMpeg_input(JNIEnv * env, jobject obj, jbyteArray data,jint len){

    return codec->input((uint8_t *) env->GetByteArrayElements(data, JNI_FALSE),len);
}
